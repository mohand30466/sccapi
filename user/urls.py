...
from .views import  BussinessStaffViews,InvoiceViews,ToDoListViews, BussinessUsViews, HoursViews, ShiftViews, UserViews, UserProfileViews,PostViews, LikeViews,PokeViews,CommentsViews,MessageViews,CustomAuthToken,PlogPostcommetsViews,PlogPostViews,ContactUsViews,PaysleeveViews
...
router.register(r"invoice",InvoiceViews)
