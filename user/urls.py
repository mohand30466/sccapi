...
from .views import  BussinessStaffViews,ToDoListViews,InvoiceViews, BussinessUsViews, HoursViews, InvoicesViews, ShiftViews, UserViews, UserProfileViews,PostViews, LikeViews,PokeViews,CommentsViews,MessageViews,CustomAuthToken,PlogPostcommetsViews,PlogPostViews,ContactUsViews,PaysleeveViews
...
router.register(r"myinvoice",InvoiceViews)
